...
export default function PricingCalculator({
  ...
  const attendeeCost = attendees * 0.5;

  const totalEstimate =
    baseCost + languageCost + premiumCost + addonCost + attendeeCost;
          ...
          {showHeading && (
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-base text-muted-foreground max-w-2xl mx-auto">
                Build your perfect multilingual solution. Only pay for what you
                need.
              </p>
            </div>
          )}
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="space-y-5">
                ...
                <p className="text-xs text-muted-foreground -mt-4">
                  Choose the type of translation service you need
                </p>
              ...
              <div className="space-y-5">
                ...
                <p className="text-xs text-muted-foreground -mt-4">
                  Number of viewers or participants
                </p>
                <div className="flex items-center gap-4">
                  <button
                  ...
                  <button
                    onClick={() =>
                      setAttendees(Math.min(10000, attendees + 100))
                    }
                    className="size-9 rounded-lg border border-border flex items-center justify-center hover:bg-muted/50 transition-colors shrink-0"
                  >
                    <Plus className="size-4" />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">
                    +${PREMIUM_LANG_RATE}/hr
                  </span>
                </div>
                <p className="text-xs text-muted-foreground -mt-3">
                  Add support for complex languages (Chinese, Japanese, Arabic,
                  etc.)
                </p>
                <button
              ...
              <div className="mt-4 p-4 rounded-xl border border-border/50 bg-card">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-xs text-muted-foreground leading-relaxed">
                    ...
                    <br />
                    Translate between 100+ languages with AI-powered accuracy.
                    Human review available for guaranteed quality.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              <div className="relative w-full max-w-lg bg-card rounded-2xl border border-border/50 shadow-2xl p-6 md:p-8 max-h-[90vh] overflow-y-auto">
                ...
                <p className="text-xs text-muted-foreground mb-6">
                  {hours}hr &middot; {languages} lang{languages > 1 ? "s" : ""}{" "}
                  &middot; {attendees.toLocaleString()} attendees
                </p>
                <form
                  onSubmit={async (e) => {
                    e.preventDefault();
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full h-10 px-3 rounded-lg border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors ${fieldErrors.firstName ? "border-red-500" : "border-border"}`}
                        placeholder="John"
                        required
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full h-10 px-3 rounded-lg border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors ${fieldErrors.lastName ? "border-red-500" : "border-border"}`}
                        placeholder="Doe"
                        required
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full h-10 px-3 rounded-lg border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors ${fieldErrors.email ? "border-red-500" : "border-border"}`}
